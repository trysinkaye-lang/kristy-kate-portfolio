...
export default function AboutPage() {
  return (
    <main id="main-content" className="portfolio-v2 about-page min-h-screen pb-20 pt-36">
      <div className="portfolio-shell">
        <header className="about-hero grid gap-10 border-b border-white/[.09] pb-16 lg:grid-cols-[.8fr_1.2fr] lg:gap-20 lg:pb-24">
          <h1 className="text-[clamp(3.6rem,7vw,6.8rem)] font-semibold leading-[.9] tracking-[-.06em] text-white">Hello! I’m Kristy Kate.</h1>
          <div className="space-y-6 text-lg leading-8 text-zinc-400 lg:pt-3">
        ...
        <section className="about-section border-b border-white/[.09] py-16 lg:py-24">
          <div className="grid gap-10 lg:grid-cols-[.30fr_.70fr] lg:gap-16">
            <div>
              <p className="v2-kicker">How I work</p>
              <h2 className="mt-4 max-w-xs text-3xl font-semibold tracking-[-.035em] text-white">From messy requirements to a usable system.</h2>
        ...
        <section className="about-section grid gap-10 border-b border-white/[.09] py-16 lg:grid-cols-[.38fr_.62fr] lg:py-24">
          <div><p className="v2-kicker">Education</p></div>
          <div className="about-education-card rounded-[2rem] border border-white/[.09] p-7 sm:p-9">
        ...
        <section className="about-section py-16 lg:py-24">
          ...
          <div className="mt-8 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
            {services.map(({ icon: Icon, label }) => (
              <div className="about-service-card rounded-2xl border border-white/[.09] p-6" key={label}>
                <Icon size={22} />
        ...
        <section className="about-section border-y border-white/[.09] py-16 lg:py-24">
          <p className="v2-kicker">Stack</p>
          <h2 className="mt-4 text-3xl font-semibold text-white sm:text-4xl">Tools I work with</h2>
          <InteractiveToolGrid />
        </section>

        <section className="about-section py-24 text-center">
          <p className="v2-kicker">Explore the work</p>
          <h2 className="mx-auto mt-5 max-w-3xl text-4xl font-semibold tracking-[-.045em] text-white sm:text-5xl">Want to see how this approach turns into real systems?</h2>
