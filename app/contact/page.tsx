...
export default function ContactPage() {
  return (
    <main id="main-content" className="portfolio-v2 contact-page relative min-h-screen overflow-hidden px-5 pb-24 pt-36">
      ...
      <div className="contact-shell relative z-10 mx-auto w-full max-w-6xl">
        <Link href="/" className="contact-back-link inline-flex items-center gap-2 text-sm text-zinc-500 transition hover:text-white"><ArrowLeft size={16} /> Back home</Link>
        <div className="contact-hero mt-12 grid gap-12 lg:grid-cols-[1.12fr_.88fr] lg:items-end">
        ...
        <div className="contact-options mt-20 grid gap-4 md:grid-cols-3">
