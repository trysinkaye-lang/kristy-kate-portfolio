    ...
    <main id="main-content" className="portfolio-v2 editorial-page project-detail-page min-h-screen pb-20 pt-36">
      <div className="portfolio-shell">
        ...
        <header className="page-hero mt-10 grid gap-10 border-b border-white/[.09] pb-14 lg:grid-cols-[1.2fr_.8fr] lg:items-end lg:pb-20">
          <div><div className="project-meta flex items-center gap-3 text-xs uppercase tracking-[.18em] text-zinc-600"><span>0{projectIndex + 1}</span><span className="h-px w-10 bg-white/10" /><span>{project.status}</span></div><h1 className="page-title mt-7 max-w-5xl text-[clamp(4rem,8vw,7.5rem)] font-semibold leading-[.86] tracking-[-.065em] text-white">{project.shortTitle}</h1><p className="page-intro mt-6 max-w-2xl text-xl leading-8 text-zinc-400">{project.title}</p></div>
