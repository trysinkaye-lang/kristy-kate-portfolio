...
export const projects: Project[] = [
  {
    slug: "rbim",
    title: "Registry of Barangay Inhabitants and Migrants (RBIM Hybrid)",
    shortTitle: "RBIM Hybrid",
    category: ["Information Systems", "Full Stack", "Desktop", "Web", "UI/UX"],
    status: "Pilot / production hardening",
    overview: "A hybrid population information platform combining an offline-first barangay desktop encoder with secure online barangay, municipality, and developer portals backed by a central PostgreSQL service.",
    problem: "Barangay population records need dependable offline encoding, controlled online visibility, accurate household and individual relationships, validation, reporting, and synchronization without allowing users to cross administrative boundaries or create duplicate records.",
    solution: "RBIM Hybrid combines a Tauri/SQLite desktop application with React-based web portals, a Node.js API, PostgreSQL, role-scoped access, validation, audit-oriented workflows, and production deployment configuration. Desktop data is designed to sync to the central server when connectivity returns while online portals read only the data authorized for each role and geographic scope.",
    role: "Full-Stack Software Developer / UI Designer",
    technologies: ["React", "TypeScript", "Tailwind CSS", "Node.js", "PostgreSQL", "SQLite", "Tauri", "Rust", "Docker"],
    highlights: ["Offline-to-online sync", "Role-scoped portals", "Barangay Supervisor workflow"],
    impact: [
      "Evolved RBIM from a desktop-focused records application into a hybrid architecture spanning offline barangay encoding and centralized online monitoring and administration.",
      "Implemented and refined role boundaries for barangay users, Barangay Supervisors, municipality monitoring/administration, and developer-level system oversight.",
      "Added production-focused safeguards around questionnaire validation, Manila-based Date Encoded handling, geography integrity, deployment configuration, and controlled record workflows.",
      "Supports structured household, individual, migration, certificate, reporting, lifecycle-status, review, and audit-oriented workflows within one operational platform."
    ],
    features: ["Offline-first barangay desktop encoder", "Barangay web portal", "Municipality monitoring and administration", "Developer portal", "Barangay Supervisor review workflow", "Household and individual profiles", "Q1–Q62 questionnaire", "Certificates and reports", "Migration and residency tracking", "Lifecycle status updates", "Role-based access control", "PostgreSQL-backed central services", "Desktop-to-server synchronization", "Validation and audit-oriented workflows"],
    challenges: ["Synchronizing offline and online workflows without duplication", "Enforcing municipality and barangay data boundaries", "Modeling complex household, family, migration, and lifecycle rules", "Preparing a multi-surface system for reliable production deployment"],
    lessons: ["Access control and geographic scope should be modeled as architecture, not only UI rules", "Offline-first systems need explicit synchronization and conflict assumptions", "Production readiness requires testing deployment configuration as carefully as application features", "Usability, data integrity, and operational permissions must be designed together"],
  ...
  },
  {
    ...
    impact: [
      ...
      "Designed for practical office use with local data storage, controlled updates, automatic locking, and clear age-aware reporting behavior."
    ],
    features: ["Adolescent profile management", "Barangay-level insights", "Age distribution reporting", "Civil status and enrollment analytics", "Pregnancy-history tracking", "Import and export workflows", "Encoded-by and date tracking", "Auto-lock behavior", "Reports", "Account settings"],
